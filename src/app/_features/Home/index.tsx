      ...
      <div className="relative bg-slate-600">
        ...
        <div className="absolute flex justify-center gap-6 bottom-20 right-0 left-0">
          <Link
            ...
            className="flex w-44 h-12 items-center justify-center border rounded-md bg-opacity-50 text-white font-semibold hover:bg-violet-600 hover:border-purple-800 transition-all duration-150 ease-linear backdrop-blur-lg"
          >
          ...
          <Link
            ...
            className="flex w-44 h-12 items-center justify-center border rounded-md bg-opacity-50 text-white font-semibold hover:bg-violet-600 hover:border-purple-800 backdrop-blur-lg"
          >
