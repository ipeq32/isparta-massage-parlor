      ...
      <div className="relative bg-slate-600">
        ...
        <div className="absolute flex justify-center gap-6 bottom-20 right-0 left-0">
          <Link
            ...
            className="flex w-44 h-12 items-center justify-center border rounded-md bg-opacity-50 text-white font-semibold hover:bg-gray-800 hover:border-gray-800 transition-all duration-150 ease-linear"
          >
            Hemen Arayın!
          </Link>
          <Link
            ...
            className="flex w-36 h-12 items-center justify-center border rounded-md bg-opacity-50 text-white font-semibold hover:bg-gray-800 hover:border-gray-800"
          >
